...
public class ChangeCategoryWithIdCommand : IRequest
{
...
public class ChangeCategoryCommandHandler : IRequestHandler<ChangeCategoryWithIdCommand, Unit>
{
    ...
    public async Task<Unit> Handle(ChangeCategoryWithIdCommand request, CancellationToken cancellationToken)
    {
